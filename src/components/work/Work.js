            ...
            <Swiper
                ...
                <SwiperSlide className="work">
                    <div className={"work__box pointer relative"}>
                        ...
                        <div className={"work__meta absolute"}>
                            <a href={"https://www.labona.cz/"} className={"work__btn"} target={"_blank"} rel={"noreferrer"}>Navštívit web</a>
                        </div>
                    </div>
                </SwiperSlide>
                ...
                <SwiperSlide className="work">
                    <div className={"work__box pointer relative"}>
                        ...
                        <div className={"work__meta absolute"}>
                            <a href={"https://www.provanoce.cz/"} className={"work__btn"} target={"_blank"} rel={"noreferrer"}>Navštívit web</a>
                        </div>
                    </div>
                </SwiperSlide>
                ...
                <SwiperSlide className="work">
                    <div className={"work__box pointer relative"}>
                        ...
                        <div className={"work__meta absolute"}>
                            <a href={"https://www.dratel.cz/"} className={"work__btn"} target={"_blank"} rel={"noreferrer"}>Navštívit web</a>
                        </div>
                    </div>
                </SwiperSlide>
                ...
                <SwiperSlide className="work">
                    <div className={"work__box pointer relative"}>
                        ...
                        <div className={"work__meta absolute"}>
                            <a href={"https://www.tozame.cz/"} className={"work__btn"} target={"_blank"} rel={"noreferrer"}>Navštívit web</a>
                        </div>
                    </div>
                </SwiperSlide>
